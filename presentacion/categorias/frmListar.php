...
<div class="container">
  <div class="table-wrapper">
    <div class="table-title">
      <div class="form-row">
        <div class="col-md-4">
          <a href="index.php?mod=cat&form=li" class="a-titulo-form"><h2>Gestión de
            <b>Categorías</b></h2></a>
          </div>
          <div class="col-md-3">
          ...
          <div class="col-md-5">
            ...
            <i class="material-icons">&#xe879;</i><span>Cerrar</span></button>
              <button type="button" class="btn btn-success" onclick="location.replace('index.php?mod=cat&form=nu');">
            ...
            <tbody>
              ...
              foreach ( $Obj_Paginador->RegistrosPaginados as $Fila ) {
                ...
                <tr>
                  ...
                  <td>
                    <a href="index.php?mod=cat&form=ed&id=<?php echo $Fila['IdCategoria'];?>" class="edit"><i class="material-icons" data-toggle="tooltip"
                      title="Editar">&#xE254;</i></a>
          ...
          <script type="text/javascript">
            function Eliminar(paId){
              if(confirm('¿Confirma eliminar este registro?')){
                window.location.replace('index.php?mod=cat&form=el&id=' + paId);
              }
            }
          </script>
          <?php
